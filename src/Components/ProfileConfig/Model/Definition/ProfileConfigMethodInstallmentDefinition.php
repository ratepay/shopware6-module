...
namespace Ratepay\RatepayPayments\Components\ProfileConfig\Model\Definition;

use Ratepay\RatepayPayments\Components\ProfileConfig\Model\Collection\ProfileConfigMethodInstallmentCollection;
