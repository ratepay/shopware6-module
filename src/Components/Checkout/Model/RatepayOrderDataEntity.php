...
class RatepayOrderDataEntity extends Entity
{
     ...
     * @var string
     */
    final public const FIELD_DESCRIPTOR = 'descriptor';

    /**
     * @var string
     */
    final public const FIELD_SHIPPING_POSITION_ID = 'shippingPositionId';

    /**
     * @var string
     */
    final public const FIELD_SHIPPING_POSITION = 'shippingPosition';

    /**
     * @var string
     */
    final public const FIELD_SUCCESSFUL = 'successful';

    /**
     * @var string
     */
    final public const FIELD_SEND_DISCOUNT_AS_CART_ITEM = 'sendDiscountAsCartItem';

    /**
     * @var string
     */
    final public const FIELD_SEND_SHIPPING_COSTS_AS_CART_ITEM = 'sendShippingCostsAsCartItem';
