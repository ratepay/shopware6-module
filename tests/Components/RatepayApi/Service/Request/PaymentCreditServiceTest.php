...
use Ratepay\RpayPayments\Tests\Mock\RatepayApi\Service\Request\PaymentCreditServiceMock;
use Ratepay\RpayPayments\Tests\Mock\RatepayApi\Service\Request\PaymentRequestServiceMock;
use Shopware\Core\Checkout\Order\OrderEntity;
use Shopware\Core\Framework\Context;
use Shopware\Core\Framework\Test\TestCaseBase\KernelTestBehaviour;

class PaymentCreditServiceTest extends AbstractRequestService
{
    ...
    protected function getServiceMock(): ?AbstractRequest
    {
        ...
        return new PaymentCreditServiceMock($headFactory, $shoppingBasketFactory);
    }
