...
use Ratepay\RpayPayments\Tests\Mock\RatepayApi\Service\Request\PaymentCancelServiceMock;
use Ratepay\RpayPayments\Tests\Mock\RatepayApi\Service\Request\PaymentRequestServiceMock;
use Shopware\Core\Checkout\Order\OrderEntity;
use Shopware\Core\Framework\Context;
use Shopware\Core\Framework\Test\TestCaseBase\KernelTestBehaviour;

class PaymentCancelServiceTest extends AbstractRequestService
{
    ...
    public function testGetRequestContent(): void
    {
        ...
        self::assertNotNull($content->getShoppingBasket(), 'basket must be set for PaymentCancel');
        self::assertNull($content->getCustomer(), 'customer is not required for PaymentCancel');
        self::assertNull($content->getPayment(), 'payment is not required for PaymentCancel');
        self::assertNull($content->getInvoicing(), 'invoice is not required for PaymentCancel');
    }
    ...
    protected function getServiceMock(): ?AbstractRequest
    {
        ...
        return new PaymentCancelServiceMock($headFactory, $shoppingBasketFactory);
    }
