    ...
    public function testFullConvert(): void
    {
        $profileRequestResponse = $this->getProfileRequestResponse([
            ...
            'installmentConfig' => [
                ...
                'interestrate-min' => '3',
                'payment-firstday' => 2,
                'interestrate-default' => 10,
                'service-charge' => 5
            ],
        ]);

        $paymentMethodsRepo = new PaymentMethodRepositoryMock([
        ...
        self::assertEquals(ProfileConfigMethodInstallmentEntity::PAYMENT_TYPE_DIRECT_DEBIT, $installmentConfigs[0][ProfileConfigMethodInstallmentEntity::FIELD_DEFAULT_PAYMENT_TYPE]);
        self::assertEquals(10, $installmentConfigs[0][ProfileConfigMethodInstallmentEntity::FIELD_DEFAULT_INTEREST_RATE]);
        self::assertEquals(5, $installmentConfigs[0][ProfileConfigMethodInstallmentEntity::FIELD_SERVICE_CHARGE]);
    }
